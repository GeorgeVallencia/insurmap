...
//                 <button onClick={() => setRole("UNDERWRITER")} className="p-4 border rounded-xl hover:text-white hover:bg-black">
//                   Underwriter
//                 </button>
//                 <button onClick={() => setRole("BROKER")} className="p-4 border rounded-xl hover:text-white hover:bg-black">
//                   Broker / Agent
//                 </button>
//                 <button onClick={() => setRole("INSURER")} className="p-4 border rounded-xl hover:text-white hover:bg-black">
//                   Insurer
//                 </button>
//                 <button onClick={() => setRole("CLAIMS")} className="p-4 border rounded-xl hover:text-white hover:bg-black">
//                   Claims Manager
//                 </button>
//                 <button onClick={() => setRole("REINSURER")} className="p-4 border rounded-xl hover:text-white hover:bg-black col-span-full">
//                   Reinsurer
//                 </button>
//               </div>
//             </>
//           ) : (
//             <Form role={role} goBack={() => setRole(null)} />
//           )}
//         </div>
//       </div>
//     </div>
...
// function Form({ role, goBack }: { role: Role; goBack: () => void }) {
//   return (
...
//             <select required className="mt-1 block w-full rounded-md border px-3 py-2">
...
//       <button type="submit" className="w-full cursor-pointer bg-black text-white py-2 rounded-md hover:bg-black">
//         Sign Up
//       </button>
